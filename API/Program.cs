...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "TestProj3009001", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<TestProj3009001Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "TestProj3009001 API v1");
